...
- Invoke the `mighty-powers:advanced-elicitation` skill with the current design system content
...
- Invoke the `mighty-powers:party-mode` skill with the current design system choice
