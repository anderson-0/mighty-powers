...
- Invoke the `mighty-powers:advanced-elicitation` skill with the current responsive/accessibility content
...
- Invoke the `mighty-powers:party-mode` skill with the current responsive/accessibility strategy
