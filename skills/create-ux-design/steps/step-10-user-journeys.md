...
- Invoke the `mighty-powers:advanced-elicitation` skill with the current user journey content
...
- Invoke the `mighty-powers:party-mode` skill with the current user journeys
