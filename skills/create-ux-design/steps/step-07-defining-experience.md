...
- Invoke the `mighty-powers:advanced-elicitation` skill with the current defining experience content
...
- Invoke the `mighty-powers:party-mode` skill with the current defining experience
