...
- Invoke the `mighty-powers:advanced-elicitation` skill with the current core experience content
...
- Invoke the `mighty-powers:party-mode` skill with the current core experience definition
