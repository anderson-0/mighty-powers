...
- Invoke the `mighty-powers:advanced-elicitation` skill with the current emotional response content
...
- Invoke the `mighty-powers:party-mode` skill with the current emotional response definition
