...
- Invoke the `mighty-powers:advanced-elicitation` skill with the current component strategy content
...
- Invoke the `mighty-powers:party-mode` skill with the current component strategy
