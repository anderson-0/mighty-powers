...
validateWorkflow: './steps/step-v-01-discovery.md'
---
...
1. Load config from `config.yaml` and resolve::
...
Then read fully and follow: `{validateWorkflow}` (steps/step-v-01-discovery.md)
