...
- Invoke the `mighty-powers:advanced-elicitation` skill with specific decision categories
...
- Invoke the `mighty-powers:party-mode` skill with architectural decisions context
